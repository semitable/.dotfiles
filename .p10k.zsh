# Generated by Powerlevel10k configuration wizard on 2020-03-23 at 15:00 GMT.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 17358.
# Wizard options: nerdfont-complete + powerline, small icons, classic, unicode, dark,
# 24h time, vertical separators, sharp heads, slanted tails, 2 lines, dotted,
# left frame, compact, many icons, concise, transient_prompt, instant_prompt=verbose.
